...
//	log.Fatal(http.ListenAndServe("localhost:4444", nil))//For use behind reverse proxy, make sure to send X-Real-IP header. Disable above line to use this one, also enable line 58 and disable line 59.
}
